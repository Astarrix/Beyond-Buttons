...
void FMGC_Toolkit::SET(UMagicNodeScript* NewScriptObject) {
	if ((NewScriptObject!=ScriptObject_Inline.Get())&&(NewScriptObject!=nullptr)) {
		UMagicNodeScript* OldScriptObject = ScriptObject_Inline.Get();
...
UMagicNodeScript* FMGC_Toolkit::GET() const {
	return ScriptObject_Inline.Get();
}
...
FString FMGC_Toolkit::GetReferencerName() const
{
	return TEXT("FMGC_Toolkit");
}
